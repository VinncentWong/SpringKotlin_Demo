...
class UserController(
    ...
    @PostMapping("/create")
    override fun createUser(@Valid @RequestBody dto: CreateUserDto): ResponseEntity<Response> {
        return this.service.createUser(dto)
    }

    @PostMapping("/login")
    override fun loginUser(@Valid @RequestBody dto: LoginUserDto): ResponseEntity<Map<String, Any>> {
